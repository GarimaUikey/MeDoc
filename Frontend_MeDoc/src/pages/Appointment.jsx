      ...
      <div className='flex flex-col sm:flex-row gap-4  mt-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div>
            ...
            <p className='text-sm text-black-500 max-w-[700px] mt-1'>{docInfo.about} </p>
          </div>
        ...
        <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4 '>
          {
            docSlots.length && docSlots[slotIndex].map((item, index) => (
              ...
              <p onClick={() => setSlotTime(item.time)} className={`text-sm font-light flex-shrink-0 px-5 py-2 mb-3 rounded-full cursor-pointer ${item.time === slotTime ? 'bg-primary text-white' : 'text-black-400 border border-gray-300'}`} key={index}>
